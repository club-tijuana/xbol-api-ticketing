...
namespace XBOL.Ticketing.Data.Extensions
{
    public static class RepositoryConfiguration
    {
        public static IServiceCollection ConfigureRepositories(this IServiceCollection services)
        {
            ...
            services.AddScoped<IBundleEventScheduleRepository, BundleEventScheduleRepository>();
            services.AddScoped<BundleSectionRepository>();
            services.AddScoped<BundleSeatRepository>();
            ...
            services.AddScoped<PriceListItemRepository>();
